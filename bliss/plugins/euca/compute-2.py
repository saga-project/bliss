...
class EucaCompute(object):
    ...
    def __init__(self, computedescription,  plugin, service_object):
        self.pi = plugin
        self.so = plugin
        self.url = self.so._url
        self.image = furl(self.so._url.__str__()).path.segments[-1]
        ...
        self.pi.log_info("Server: " + self.host)
        self.pi.log_info("Access key: " + self.access_key)
        self.pi.log_info("Private key: " + self.private_key)
    ...
    def create_instance(self):
        ...
        self.reservation=remote_image.run(key_name="userkey")
...
#self.state = bliss.saga.resource.state.Pending
    ...
    def get_description(self):
        ...
        print "IN GET DESCRIPTION ALALALLALAL"
        return cd
