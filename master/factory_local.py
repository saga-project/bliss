...
job_test_urls = ['fork://localhost', 'ssh://localhost']
...
file_test_urls = ['sftp://localhost/tmp/ /home/sagaproj/.ssh/id_rsa.pub', 'sftp://faust.cct.lsu.edu/tmp/ /home/sagaproj/.ssh/id_rsa.pub']
